      ...
      <div class="navbar-wrapper">
        <div class="navbar-container content">
          <div class="collapse navbar-collapse show" id="navbar-mobile">
            <ul class="nav navbar-nav mr-auto float-left text-light">Learners</ul>
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true" data-img="/assets/images/backgrounds/02.jpg">
      ...
      <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="active"><a href="/admin/learner"><i class="ft-credit-card"></i><span class="menu-title" data-i18n="">Learners</span></a>
            </li>
              ...
              <li class="list-group-item">
                <div class="container pl-0 ">
                  <div class="row">
                    ...
                    <div class="col-2">
                      <p><a class="pr-1 btn btn-info" href="/admin/learner/view/{{ $t->id }}">View</a></p>
                    </div>
                    <div class="col-2">
                      <form action="/admin/learner/delete/{{$t->id}}" method="POST">
                        @csrf
                        @method('DELETE')

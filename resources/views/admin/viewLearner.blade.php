                      ...
                      <div class="card">
                        <div class="card-body">
                          <div class="d-flex flex-column align-items-center text-center">
                            ...
                            <div class="mt-3">
                              <h4>{{ $tutor->learner_name }}</h4>
                              <a class="btn btn-outline-primary" href="//api.whatsapp.com/send?phone={{$tutor->phone}}">Message</a>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="col-md-8">
                      <div class="card mb-3">
                        <div class="card-body">
                          ...
                          <div class="row ">
                            <div class="col-sm-3">
                              <h6 class="mb-0 mt-1">I Want to Learn:</h6> <br>
                            </div>
                            <div class="col-sm-9 text-secondary mt-1">
                                @foreach($tutor->toLearn as $c)
                                <p>{{ $c }}</p>
                                @endforeach
                            </div>
                          </div>

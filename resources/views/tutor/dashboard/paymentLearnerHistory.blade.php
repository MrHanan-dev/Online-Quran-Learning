    ...
    <div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true" data-img="/assets/images/backgrounds/02.jpg">
      ...
      <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
          ...
          <li class=" active"><a href="/tutor/paymentLearnerHistory"><i class="ft-image"></i><span class="menu-title" data-i18n="">Payment History</span></a>
          </li>
        </ul>
      </div>
            ...
            <table class="table table-responsive">
                ...
                @foreach( $learner as $value)
                  <tr style="color:black">
                    ...
                    <td class="text-capitalize">{{ $value->learner_name}}</td>
                    <td>{{ $value->email }}</td>
                    ...
                    <td>
                      <form class="" action="/tutor/viewLearnerpayment/{{$value->course_id}}" method="get">
                        @csrf

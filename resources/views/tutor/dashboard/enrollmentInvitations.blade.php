    ...
    <div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true" data-img="/assets/images/backgrounds/02.jpg">
      ...
      <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
          ...
          <li class=" active"><a href="/tutor/demoClassInvitations"><i class="ft-layers"></i><span class="menu-title" data-i18n="">Invitations</span></a>
          </li>
                  ...
                  <div class="col-lg-12 col-md-12">
                      <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Course Enrollment Invitations</h4>
                        </div>
                                      ...
                                      <tbody class="mt-4">
                                       ...
                                       <tr style="color:black">
                                         ...
                                         <td>
                                           ...
                                           <form class="" action="/tutor/approveEnrollment/{{$learner->id}}" method="get">
                                             @csrf
                                             @method('POST')
                                             ...
                                             <input type="submit" class="btn btn-info btn-sm" name="submit" value="Approve">
                                           </form>
                                         </td>
                                         <td>
                                           <form class="" action="/tutor/rejectEnrollment/{{$learner->id}}" method="get">
                                             @csrf
                                             @method('POST')
                                             <input type="text" name="course_name" value="{{$learner->name}}" hidden>
                                             <input type="text" name="course_schedule" value="{{$learner->schedule}}" hidden>

      ...
      <div class="navbar-wrapper">
        <div class="navbar-container content">
          <div class="collapse navbar-collapse show" id="navbar-mobile">
            <ul class="nav navbar-nav mr-auto float-left text-light">Dashboard</ul>
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true" data-img="/assets/images/backgrounds/02.jpg">
      ...
      <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
          ...
          <li class=" active"><a href="/tutor/findLearner"><i class="ft-credit-card"></i><span class="menu-title" data-i18n="">Find Learner</span></a>
          </li>
                      ...
                      <div class="card">
                        <div class="card-body">
                          ...
                          <div class="d-flex flex-column align-items-center text-center">
                            <img src="/assets/images/learnerProfile-Pictures/{{$learner->photo}}" alt="" class="rounded-circle" width="150">
                            <div class="mt-3">
                              <h4>{{ $learner->learner_name }}</h4>
                              <p class="text-secondary mb-1">{{ $learner->email}}</p>
                              <a  class="btn btn-outline-primary" href="//api.whatsapp.com/send?phone={{$learner->phone}}">Message</a>
                            </div>
                          </div>
                        </div>
                      </div>

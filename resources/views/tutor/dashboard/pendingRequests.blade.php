                  ...
                  <div class="col-lg-12 col-md-12">
                      <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Demo Class Invitations</h4>
                        </div>
                                      ...
                                      <tbody class="mt-4">
                                        ...
                                        @foreach( $learner as $learner)
                                            <tr style="color:black">
                                              ...
                                              <td>
                                                <form class="" action="/tutor/approve/{{$learner->id}}" method="get">
                                                  @csrf
                                                  @method('POST')
                                              ...
                                              <td>
                                                <form class="" action="/tutor/reject/{{$learner->id}}" method="get">
                                                  @csrf
                                                  @method('POST')
                                                  <input type="text" name="course_name" value="{{$learner->name}}" hidden>
                                                  <input type="text" name="course_schedule" value="{{$learner->schedule}}" hidden>

                      ...
                      <div class="card">
                          ...
                          <div class="card-content collapse show">
                              <div class="card-body">
                                        ...
                                        <div class="media p-3">
                                            <div class="media-body">
                                              <div class="container">
                                                <div class="row">
                                                  <div class="col-4">
                                                    <h4><a class="text-left mr-5" href="/tutor/viewCourse/{{$p->id}}">{{$p->name}} </a> </h4>
                                                  </div>
                                                  <div class="col-5">

                                                  </div>
                                                  <div class="col-3">
                                                    <p class="text-right text-dark">Course Fee : {{$p->fees}}$</p>
                                                  </div>
                                                </div>
                                ...
                                @endforeach
                                @else
                                 <h4>You Have Not Added Any Course Yet</h4>
                                @endif
                              </div>
                          </div>
                      </div>

                      ...
                      <div class="card">
                        <div class="card-body">
                          ...
                          <div class="d-flex flex-column align-items-center text-center">
                            <img src="/assets/images/tutorProfile-Pictures/{{Auth::guard('tutor')->user()->photo}}" alt="Admin" class="rounded-circle" width="150">
                            <div class="mt-3">
                              <h3>{{ $tutor->name }}</h3>
                              <p class="text-secondary mb-2">{{ $tutor->email}}</p>
                              <h5 class="mb-1">{{$tutor->phone}}</h5>
                            </div>
                          </div>
                        </div>
                      </div>

                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                  ...
                                  @endif
                                    ...
                                    <form action="/tutor/updateCourse/{{$course->id}}" method="post">
                                        @csrf
                                        @method('PUT')
                                        <div class="row gutters">
                                            ...
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" name="fees" value="{{$course->fees}}" placeholder="Enter Course Fee">
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                <div class="form-group">
                                            ...
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                <div class="form-group">
                                                    <label for="schedule">Enter days and time Schedule</label>
                                                    <div class="mb-3">
                                                        <textarea class="form-control" name="schedule" rows="3">{{$course->schedule}}</textarea>
                                                      </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="pre">How course will be conducted?</label>
                                                <input type="text" class="form-control" name="howToConduct" value="{{$course->howToConduct}}" placeholder="Eg:Zoom, Skype, Whatsapp etc.">
                                            </div>
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                <div class="form-group">
                                                    <label for="duration">Duration</label>
                                                    <input type="text" class="form-control" name="duration" value="{{$course->duration}}" placeholder="Enter Course Duration">
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                <div class="form-group">
                                                    <label for="howToConduct">Pre-Requisite of Course?</label>
                                                    <input type="text" class="form-control" name="prerequisite" value="{{$course->prerequisite}}" placeholder="Eg:Pre-Recosite of Hifz is Recitation.">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row gutters">
                                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                    <div class="text-right">
                                                        <a href="/tutor/updateCourse/{{$course->id}}"><button type="submit" class="btn btn-primary">Update</button></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div> <br>
